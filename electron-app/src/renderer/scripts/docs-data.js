...
function getTourSteps() {
  return [
    ...
    { selector: '[data-tour="global-version"]', title: _t('td.tour.7.title', 'Odoo Version'), text: _t('td.tour.7.text', 'Global version selector — changes install targets, dashboard filter, and settings paths.', { versions: _odooVersions ? _odooVersions.versions.map(v => v.key).join(', ') : '15, 17, 18, 19' }), position: 'bottom' },
    { selector: '[data-tour="settings"]', title: _t('td.tour.8.title', 'Settings'), text: _t('td.tour.8.text', 'Settings tab — configure directories, database, themes, and more.'), position: 'bottom', panelBefore: 'settings' },
    { selector: '[data-tour="theme-presets"]', title: _t('td.tour.8a.title', 'Theme Presets'), text: _t('td.tour.8a.text', 'Choose from 4 themes: Default, Amethyst, Cyberpunk, Pink Luxury. Each with dark/light mode.'), position: 'bottom', panelBefore: 'settings' },
    { selector: '[data-tour="settings-version"]', title: _t('td.tour.8b.title', 'Odoo Version'), text: _t('td.tour.8b.text', 'Select Odoo version. Auto-adjusts Python, PostgreSQL versions and download URLs.'), position: 'bottom', panelBefore: 'settings' },
    { selector: '[data-tour="settings-dirs"]', title: _t('td.tour.8c.title', 'Directories'), text: _t('td.tour.8c.text', 'Base directory for Odoo source + venv. Projects directory for all your projects.'), position: 'bottom', panelBefore: 'settings' },
    { selector: '[data-tour="settings-db"]', title: _t('td.tour.8d.title', 'Database Config'), text: _t('td.tour.8d.text', 'PostgreSQL connection: host, port, user, password. These are defaults for new projects.'), position: 'top', panelBefore: 'settings' },
