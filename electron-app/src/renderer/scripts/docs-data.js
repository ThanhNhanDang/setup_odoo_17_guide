...
function getTourSteps() {
  return [
    ...
    { selector: '[data-tour="settings"]', title: _t('td.tour.8.title', 'Settings'), text: _t('td.tour.8.text', 'Configure directories, database, default project settings, and appearance themes.'), position: 'bottom' },
