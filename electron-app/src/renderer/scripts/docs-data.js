...
function getTourSteps() {
  return [
    ...
    { selector: '.kanban-card:first-child .kanban-card-header', title: _t('td.tour.2a.title', 'Card Header'), text: _t('td.tour.2a.text', 'Project name, port number (click to open in browser), and duplicate button.'), position: 'bottom', panelBefore: 'dashboard' },
    { selector: '.kanban-card:first-child .kanban-card-tags', title: _t('td.tour.2b.title', 'Status Tags'), text: _t('td.tour.2b.text', 'Version badge (color-coded), running/stopped status, and custom modules count.'), position: 'bottom', panelBefore: 'dashboard' },
    { selector: '.kanban-card:first-child .kanban-log-btn', title: _t('td.tour.2c.title', 'Log Viewer'), text: _t('td.tour.2c.text', 'Open a separate log window to monitor Odoo logs in real-time. Supports filtering by log level.'), position: 'left', panelBefore: 'dashboard' },
    { selector: '.kanban-card:first-child .kanban-card-actions', title: _t('td.tour.2d.title', 'Action Buttons'), text: _t('td.tour.2d.text', 'Start/Stop Odoo, open in VS Code, open folder in Explorer, view project details, or delete the project.'), position: 'top', panelBefore: 'dashboard' },
    ...
    { selector: '#installVersion', title: _t('td.tour.7.title', 'Odoo Version'), text: _t('td.tour.7.text', 'Choose your Odoo version. Each version installs the correct Python and PostgreSQL.', { versions: _odooVersions ? _odooVersions.versions.map(v => v.key).join(', ') : '15, 17, 18, 19' }), position: 'bottom', panelBefore: 'install' },
